...
class TempTicketRepository {
    ...
    getTicketData(ticketId) {
        return __awaiter(this, void 0, void 0, function* () {
            return yield tempTicketModel_1.tempTicketModel.findById(ticketId).populate('showId');
        });
    }
    findTempTicketById(ticketId) {
        return __awaiter(this, void 0, void 0, function* () {
            return yield tempTicketModel_1.tempTicketModel.findById(ticketId).select({ _id: 0, expireAt: 0 }).populate('movieId')
