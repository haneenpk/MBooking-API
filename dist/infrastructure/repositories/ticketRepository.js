...
class TicketRepository {
    ...
    getTicketsAll() {
        return __awaiter(this, void 0, void 0, function* () {
            return yield ticketModel_1.ticketModel.find().sort({ createdAt: -1 }).populate('movieId')
                .populate('showId').populate('screenId').populate('theaterId').populate('userId');
        });
    }
    getTicketsByTheaterId(theaterId) {
        return __awaiter(this, void 0, void 0, function* () {
            return yield ticketModel_1.ticketModel.find({ theaterId }).sort({ createdAt: -1 }).populate('movieId')
                .populate('showId').populate('screenId').populate('theaterId').populate('userId');
        });
    }
